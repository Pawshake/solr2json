...
class Transformer
{
    public function transform(array $data)
    {
        ...
        if (isset($data['bs_home_visits']) && $data['bs_home_visits'] === true) {
        ...
        return [
            ...
            'profileDescription' => isset($data['ss_short_content']) ? $this->cleanUpDrupalString($data['ss_short_content']) : null,
